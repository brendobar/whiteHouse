(function ($) {
    ...
    var proCata = $('.whitehouse-pro-catagory');
    ...
    var whitehouseSearch = $('.search-nav');
    var searchClose = $('.search-close');

    whitehouseSearch.on('click', function () {
    ...
    var whitehouseMobNav = $('.whitehouse-navbar-toggler');
    var navClose = $('.nav-close');

    whitehouseMobNav.on('click', function () {
